...
outfiledir="/work/bs66/davidsonii_mapping/mapping/haplotype_caller"
...
do
    ...
    echo "gatk --java-options '-Xmx4g' HaplotypeCaller -R $genomefile -I $i -O $outfiledir/$readhead.g.vcf.gz -ERC GVCF" >> $jobscriptdir/hapcaller_$readhead.sh
done
