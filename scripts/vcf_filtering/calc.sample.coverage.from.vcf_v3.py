...
vcf = open('finalized_data/finalized_snps.vcf', 'rU')
outfile = open('finalized_data/summary_outfiles/coverage_and_het_stats.txt', 'w')
    ...
    if cols != 'header':
        ...
        for j in range(9, nindivs+9):
            ...
            if annot != 'missing':
                ...
                if annot[2][1] == '0' and annot[2][0] != '0' and annot[2][2] != '0':
                    labs[j-9][4] += 1
                else:
                    pass
            else:
